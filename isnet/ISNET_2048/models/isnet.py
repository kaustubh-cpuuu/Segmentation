...
class ISNetGTEncoder(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=1):
        ...
        self.conv_in_0 = myrebnconv(
            in_ch, 8, 3, stride=2, padding=1
        ) 
        self.conv_in = myrebnconv(
            8, 16, 3, stride=2, padding=1 # changed the input
...
class ISNetDIS(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1):
        ...
        self.conv_in_0 = nn.Conv2d(in_ch, 128, 3, stride=2, padding=1)
...
if __name__ == "__main__":
    net = ISNetGTEncoder()
    with open("gt_encoder.txt", "w") as f:

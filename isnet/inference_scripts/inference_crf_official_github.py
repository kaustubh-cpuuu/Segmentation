...
X=cv2.imread("demo_datasets/aa/0307_am_458.jpg")
y=cv2.imread("demo_datasets/ab/0307_am_458.png")
...
def crf(original_image, annotated_image, output_image, use_2d=True):
    ...
    end_time = time.time()
    print(f"CRF processing completed in {end_time - start_time:.2f} seconds.")

...
import torch
from Ptrain import get_colormap
from Pmodel import UNet_PP
from Putils import seeding, create_dir
...
def load_dataset(path, split=0.2):
    ...
    valid_x = sorted(glob(os.path.join(path, "Validation", "Images", "*")))[:10]
    valid_y = sorted(glob(os.path.join(path, "Validation", "Categories", "*")))[:10]

    return (train_x, train_y), (valid_x, valid_y), (test_x[:10], test_y[:10])
...
if __name__ == "__main__":
    ...
    path = "instance-level-human-parsing1/instance-level-human-parsing/instance-level-human-parsing"
    ...
    model = UNet_PP(num_classes=NUM_CLASSES)
    ...
    test_x = ["0000004.jpg","0000066.jpg","0000084.jpg","0002064.jpg","0000174.jpg","0002064.jpg","0007416.jpg","0008058.jpg","0001238.jpg","0001633.jpg"]
    test_y = ["0000004.png","0000066.png","0000084.png","0002064.png","0000174.png","0002064.png","0007416.png","0008058.png","0001238.png","0001633.png"]
    ...
    for x, y in tqdm(zip(test_x, test_y), total=len(test_x)):
        ...
        save_image_path = rf"C:\Users\ml2au\PycharmProjects\nikhil\Multiclass-Segmentation-on-Crowd-Instance-level-Human-Parsing-CHIP-Dataset-using-UNET\results\rgb\{name}.png"
